namespace SonicHesap.Entities.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.PersonelHareketleri",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        FisKodu = c.String(maxLength: 20),
                        ...
                        Donemi = c.DateTime(nullable: false),
                        PrimOrani = c.Decimal(nullable: false, precision: 5, scale: 2),
                        ToplamSatis = c.Decimal(nullable: false, precision: 12, scale: 2),
                        AylikMaasi = c.Decimal(nullable: false, precision: 12, scale: 2),
                        Aciklama = c.String(maxLength: 200),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.PersonelHareketleri");
